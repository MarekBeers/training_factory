 ...
 */
final class Version20200113100634 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lesson ADD instructeur_id INT DEFAULT NULL, DROP instructor_id_id, CHANGE training_id_id training_id_id INT DEFAULT NULL, CHANGE max_persons max_persons INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lesson ADD instructor_id_id INT DEFAULT NULL, DROP instructeur_id, CHANGE training_id_id training_id_id INT DEFAULT NULL, CHANGE max_persons max_persons INT NOT NULL');
