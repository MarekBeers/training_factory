 ...
 */
final class Version20200114124501 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lesson CHANGE training_id_id training_id_id INT DEFAULT NULL, CHANGE instructeur_id instructeur_id INT DEFAULT NULL, CHANGE max_persons max_persons INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE registration CHANGE lesson_id_id lesson_id_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE payment payment TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lesson CHANGE training_id_id training_id_id INT DEFAULT NULL, CHANGE instructeur_id instructeur_id INT DEFAULT NULL, CHANGE max_persons max_persons INT DEFAULT NULL');
        $this->addSql('ALTER TABLE registration CHANGE lesson_id_id lesson_id_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE payment payment SMALLINT DEFAULT NULL');
