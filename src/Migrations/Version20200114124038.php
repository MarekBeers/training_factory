 ...
 */
final class Version20200114124038 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE registration ADD user_id INT DEFAULT NULL, CHANGE lesson_id_id lesson_id_id INT DEFAULT NULL, CHANGE payment payment SMALLINT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE registration DROP user_id, CHANGE lesson_id_id lesson_id_id INT DEFAULT NULL, CHANGE payment payment SMALLINT DEFAULT NULL');
