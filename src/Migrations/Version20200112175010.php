 ...
 */
final class Version20200112175010 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lesson CHANGE instructor_id_id instructor_id_id INT DEFAULT NULL, CHANGE training_id_id training_id_id INT DEFAULT NULL, CHANGE max_persons max_persons INT NOT NULL');
